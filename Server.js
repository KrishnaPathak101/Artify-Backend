...
app.use(cors(
    {
        origin: ['http://localhost:5173','https://artify-frontend.netlify.app', 'https://artfy-frontend-un7fz0uje-krishnajis-projects.vercel.app', 'https://artfy-frontend.vercel.app']
    }
));
